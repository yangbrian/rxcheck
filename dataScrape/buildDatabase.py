...
#Thanks to the FDA, we actually can't poll more than 5000. -_-
while offset < 5000:
    ...
    for drug in data['results']:
        ...
        if 'brand_name' in drug['openfda'] or 'generic_name' in drug['openfda']:
            name = drug['openfda']['brand_name'] if 'brand_name' in drug['openfda'] else drug['openfda']['generic_name']
            if name not in drugsSaved:
                #20 lashes for what I'm about to write...
                drugInfo = {'brand_name': name,
